<template>
	<div class="navbar">
		<div class="title" :style='{"padding":"0 20px","display":"block"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"64px","fontSize":"20px","color":"#fff","float":"left"}'>{{this.$project.projectName}}</span>
		</div>
