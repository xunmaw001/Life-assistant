<template>
  <div :style='{"padding":"30px"}'>
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item :style='{"margin":"0 0 20px 0"}' label="选择试卷" prop="paperid">
      ...
      <el-form-item :style='{"padding":"0","margin":"0"}'>
        <el-button :style='{"border":"0px solid #5e9808","cursor":"pointer","padding":"0 30px","margin":"0 20px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"radial-gradient(circle, rgba(57,220,217,1) 0%, rgba(34,194,182,1) 100%)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="onSubmit">提交</el-button>
        <el-button :style='{"border":"0px solid #ccc","cursor":"pointer","padding":"0 30px","margin":"0","outline":"none","color":"#fff","borderRadius":"4px","background":"radial-gradient(circle, rgba(137,195,255,1) 0%, rgba(64,158,255,1) 100%)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' @click="back()">取消</el-button>
      </el-form-item>
    </el-form>
