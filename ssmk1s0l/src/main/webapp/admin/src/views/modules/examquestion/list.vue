      ...
      <el-form :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm" class="center-form-pv">
        <el-row :style='{"display":"block"}'>
			<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
			  <label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">试卷</label>
			...
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","outline":"none","color":"#fff","borderRadius":"4px","background":"radial-gradient(circle, rgba(137,195,255,1) 0%, rgba(64,158,255,1) 100%),rgba(30, 144, 255, 1)","width":"76px","fontSize":"14px","height":"40px"}' round @click="search()">查询</el-button>
		</el-row>
        <el-row :style='{"padding":"10px","margin":"20px 0","background":"#95d5f2","display":"flex"}'>
          <el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"radial-gradient(circle, rgba(57,148,220,1) 0%, rgba(34,114,194,1) 100%)","width":"auto","fontSize":"14px","height":"40px"}' type="primary" @click="addOrUpdateHandler()" round>新增</el-button>
          <el-button
		     :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"radial-gradient(circle, rgba(220,57,57,1) 0%, rgba(194,34,34,1) 100%)","width":"auto","fontSize":"14px","height":"40px"}'
          ...
          <download-excel v-if="isAuth('examquestion','导出')" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "试卷题目.xls">
            <!-- 导出excel -->
            <el-button
				:style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"radial-gradient(circle, rgba(57,220,217,1) 0%, rgba(34,194,182,1) 100%)","width":"auto","fontSize":"14px","height":"40px"}'
                type="primary"
            >{{'导出'}}</el-button>
          </download-excel>
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                type="text"
                size="small"
				:style='{"border":"1px solid #f8566d","cursor":"pointer","padding":"0 16px","margin":"3px 6px 3px 0","outline":"none","color":"#f8566d","borderRadius":"4px","background":"none","width":"auto","fontSize":"14px","height":"32px"}'
