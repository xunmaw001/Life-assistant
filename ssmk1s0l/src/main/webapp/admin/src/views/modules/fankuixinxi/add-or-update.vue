	...
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="反馈内容" prop="fankuineirong">
					<editor 
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.fankuineirong = this.ruleForm.fankuineirong.replace(reg,'../../../ssmk1s0l/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
