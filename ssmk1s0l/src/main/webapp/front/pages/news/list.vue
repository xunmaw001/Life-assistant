		...
		<view :style='{"padding":"0px 0","borderColor":"#21d5ae","alignItems":"flex-start","display":"block","justifyContent":"space-between","minHeight":"100vh","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230301/28586bd575de4721a42223a6e1d4b118.png) fixed","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"dashed","height":"auto"}'>
			...
			<view :style='{"width":"100%","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}'>
				...
				<view class="news-box3" :style='{"width":"calc(100% - 0px)","padding":"0px 24rpx 24rpx","margin":"24rpx 0 40rpx","height":"auto"}'>
					<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"padding":"8rpx 52rpx","margin":"0 0 32rpx","borderColor":"#f7d3ba","backgroundColor":"rgba(255,255,255,1)","borderRadius":"0","borderWidth":"0 0 6rpx 0","width":"100%","position":"relative","borderStyle":"solid","height":"auto"}'>
					  <view :style='{"padding":"0","boxShadow":"0px 0px 0px rgba(153,153,153,.6)","margin":"-4rpx 0 0 0","backgroundColor":"#999","top":"50%","borderRadius":"100%","left":"16rpx","width":"12rpx","position":"absolute","height":"12rpx"}' class="dian"></view>
					  <view :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"#333","width":"100%","lineHeight":"72rpx","fontSize":"28rpx","textOverflow":"ellipsis"}' class="title ">{{product.title}}</view>
